using ABM_Remera_Services.Models;
using System;
...
namespace ABM_Remera_Services.Services
{
    public class RemeraServices
    {
        // Esta parte es exactamente igual que la del proyecto anterior
